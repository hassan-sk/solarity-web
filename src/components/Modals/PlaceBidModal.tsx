...
const PlaceBidModal: FC<any> = ({
    ...
    return (
        <Base open={open} onClose={onClose} title="Raising Verse">
            <div className="grid grid-cols-2 gap-8 mt-8">
                ...
                <div className="col-span-1">
                    ...
                    <div className="flex">
                        ...
                        <span className="text-[12px] text-secondary mt-1">&nbsp;{selectedVerse.collection}</span>
                    </div>
            ...
            <div className="mt-7">
                <button className="rounded-full btn btn-sm float-right ml-3" onClick={onClose}>
                Cancel
                </button>
                <Button 
