      ...
      return (
        ...
        >
          ...
          <a-entity id="player">
            ...
            <a-entity
              id="leftHand"
              class="leftController controllerOnly"
              ...
              raycaster="far: 0; objects: .leftclickable;"
            ...
            <a-entity
              id="rightHand"
              class="rightController controllerOnly"
          ...
          <a-image
            width="1.5"
            height="2"
            class="clickable nocollision"
            simple-link="href: ../hub/hub.html"
            src="#hub-img"
            position="-1.9 1.1 2.9"
            rotation="0 0 0"
